...
class ChangeColor extends Component {
   ...
   async handleColorChange(value){
    ...
    render() {
        ...
        return (
            <div>
                <IconButton onMouseEnter={this.handlePopoverOpen} className={classes.iconButton}>
                ...
                <Popper id={this.props.noteId} open={open} anchorEl={anchorEl}
                    ...
                    className={classes.paper}  onMouseLeave={this.handlePopoverClose}  disableRestoreFocus>
